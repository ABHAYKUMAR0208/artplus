...
const router = require("./routes/admin/Sales-Performance-routes");
//const saleRoutes = require("./routes/shop/sale-routes");


// database setup
mongoose
    .connect('mongodb+srv://02abhaykumarr:02abhaykumarr@cluster0.qdits.mongodb.net/', {})
...
//app.use("/api/shop/sale", saleRoutes);
